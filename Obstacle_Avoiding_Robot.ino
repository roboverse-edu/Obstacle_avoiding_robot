...
#define in1 7 //Motor1  L293D Pin in1
#define in2 8 //Motor1  L293D Pin in2       
#define in3 9 //Motor2  L293D Pin in3
#define in4 10 //Motor2  L293D Pin in4                                              
#define en2 6 //Enable2 L293D Pin en2
...
void loop(){
  ...
  delay(50);
   if (distance <= 20){         //if the distance is < or = to 20cm 
    ...
    delay(300);
    if (distanceRight >= distanceLeft){   // calculate in which direction the obstacle is more far then move to that direction
      turnLeft(); //distance right is less than distance left ,so turn right
      moveStop(); 
    }
    else{
      turnRight(); //distance left is less than distance right ,so turn left
      moveStop();
    }
  }
  else{
...
void turnRight(){ //robot moves left
...
void turnLeft(){ //robot moves right
